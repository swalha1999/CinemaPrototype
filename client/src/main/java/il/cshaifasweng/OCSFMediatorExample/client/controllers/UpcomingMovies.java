/**
 * Sample Skeleton for 'UpcomingMovies.fxml' Controller Class
 */
...
public class UpcomingMovies {
    ...
    @FXML // fx:id="MoviesGrid"
    private GridPane MoviesGrid; // Value injected by FXMLLoader

    @FXML // fx:id="actionButton"
    private Button actionButton; // Value injected by FXMLLoader

    @FXML // fx:id="allButton"
    private Button allButton; // Value injected by FXMLLoader

    @FXML // fx:id="comedyButton"
    private Button comedyButton; // Value injected by FXMLLoader

    @FXML // fx:id="dramaButton"
    private Button dramaButton; // Value injected by FXMLLoader

    @FXML // fx:id="sciFiButton"
    private Button sciFiButton; // Value injected by FXMLLoader
