...
public enum MessageType implements Serializable {
    ...
    GET_ONLINE_SCREENING_FOR_MOVIE_REQUEST,
    GET_ONLINE_SCREENING_FOR_MOVIE_RESPONSE,
    ...
    DENY_PRICE_CHANGE_RESPONSE,

    // Customer Support
    REPLY_SUPPORT_TICKET_REQUEST,
    REPLY_SUPPORT_TICKET_RESPONSE,
    GET_MY_RESOLVED_TICKETS_REQUEST,
    GET_MY_RESOLVED_TICKETS_RESPONSE,
